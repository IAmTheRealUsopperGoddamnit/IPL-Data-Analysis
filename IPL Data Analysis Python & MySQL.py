...
mydb=mysql.connector.connect(host="localhost",user="root",passwd="ethan",port=3306)
mycursor=mydb.cursor()
mycursor.execute("drop database ipl")
mycursor.execute("create database ipl")

mydb=mysql.connector.connect(host="localhost",user="root",passwd="ethan",database="ipl", port=3306)
mycursor=mydb.cursor()
